...
convert_webm_to_mp4 = "ffmpeg -y -i  {web_file_path} -an -vcodec copy  {temp_file_path}/out.mkv"
convert_mp4_to_rgb = "ffmpeg -y -i  {temp_file_path}/out.mkv -s {width}x{height} -pix_fmt rgb24  {temp_file_path}/degraded.rgb"
...
class VmafUtil:
    ...
    def calaculate_vmaf_score(self):
        ...
        cur_dir = os.getcwd()
        temp_path = cur_dir + "/" + TEMP_DIR_PATH
        terminal_command = convert_webm_to_mp4.format(web_file_path=self.webm_degraded_file, temp_file_path=temp_path)
        ...
        if returned_value != 0:
            ...
            logging.info(LOGGING_PREFIX + " webm converted to mkv ")
...
if __name__ == '__main__':
    ...
    degraded_webm_file = "/Users/rajneesh.soni/Downloads/B5NsMZTCyy2w.webm"
    width = 540
    height = 360
    reference_file = "/Users/rajneesh.soni/devMedia/elastest-webrtc-qoe-meter/interview_overlay.y4m"
    dmtx_rgb_path = "/Users/rajneesh.soni/jiomeet/video_quality/dmtx-utils/dmtxread/dmtxRGBread"
